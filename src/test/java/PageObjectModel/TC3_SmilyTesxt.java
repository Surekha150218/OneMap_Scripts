...
WebDriver driver= null;
	...
	@Test
	public void ValidateSmiley() throws InterruptedException{
		
		
		
		JavascriptExecutor jse=(JavascriptExecutor)driver;
		WebElement smiley=(WebElement)jse.executeScript("return document.querySelector('wog-sentiments').shadowRoot.querySelector('div').querySelector('wog-floating-action-button').shadowRoot.querySelector('div')");
